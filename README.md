...
### Work with Sass & Foundation
    To use Sass and Foundation, you need to install them separately
    ...
    Once you've done that, you can just `sass --watch source node_modules/foundation-sites/scss` after you fire up grunt 
